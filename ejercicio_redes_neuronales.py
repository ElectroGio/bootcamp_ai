...
model_regression = keras.Sequential([
    keras.layers.Dense(units=80, activation='relu', input_shape=(2,)), # Capa oculta con 64 neuronas
    keras.layers.Dense(units=40, activation='relu'),                 # Otra capa oculta
...
# Entrenar el modelo
history_regression = model_regression.fit(X_train, y_train, epochs=10, batch_size=16, validation_split=0.1, verbose=0)
